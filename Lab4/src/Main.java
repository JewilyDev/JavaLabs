...
public class Main {
    public static void main(String[] args) {
        ...
        while (game) {
            ...
            if (board.isCheckmate()) { //проврека на мат
                System.out.println("Мат!");
                String colorName = board.getColorGaming() == 'w' ? "Белые" : "Черные"; //победил ходящий игрок, так как он делал ход
                System.out.println("Игра окончена! " + board.getColorGaming() + colorName + " победили");
                game = false;
            }
